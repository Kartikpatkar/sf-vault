...
/** Check if a URL is a Salesforce login page */
...
/** Org type color mapping */
export const ORG_TYPE_COLORS = {
  'Production': '#22c55e',
  'Sandbox': '#f59e0b',
  'Developer': '#a855f7',
  'Scratch Org': '#06b6d4',
  'Custom Domain': '#ec4899',
  'Community': '#6366f1',
  'Other': '#94a3b8'
};

/** Org type short labels for badges */
...
/** SVG Icon library — compact inline SVGs for the UI */
export const Icons = {
  ...
  folderOpen: `<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2v1"/><path d="M2 10l2.5 9h15l2.5-9H2z"/></svg>`,
  ...
  window: `<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>`,
  incognito: `<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12s2-4 5-4h10c3 0 5 4 5 4"/><circle cx="8" cy="15" r="2"/><circle cx="16" cy="15" r="2"/><path d="M10 15h4"/><path d="M2 12l4-6h12l4 6"/></svg>`,
